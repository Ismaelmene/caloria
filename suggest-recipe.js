...
module.exports = async (req, res) => {
  ...
  if (!caloriasDesejadas || !ingredientesDisponiveis) {
    return res
      .status(400)
      .json({ error: "envie 'caloriasDesejadas' e 'ingredientesDisponiveis'" });
  }
    ...
    const response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "user",
            content: `Quero uma refeição de aproximadamente ${caloriasDesejadas} calorias.
