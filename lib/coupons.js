...
// Busca o cupom marcado pra aparecer na página de vendas (campo
// "mostrarNaLanding"), se ele ainda estiver válido — usado pelo endpoint
// público /api/featured-coupon, que a página de vendas chama mesmo sem
// ninguém logado. Só deve existir um cupom em destaque por vez (o painel
// admin cuida de desmarcar os outros quando você ativa um novo), mas se por
// algum motivo houver mais de um, pegamos o primeiro que ainda for válido.
